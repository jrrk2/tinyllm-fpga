...
exec python3 src/soc/bin2init.py $_fw_bin > src/soc/progmem_init.svh
puts "INFO: baked progmem_init.svh from $_fw_bin"
...
if {$_picosoc_engine} {
    ...
    exec python3 src/soc/bin2init.py $_fwbin > src/soc/progmem_init.svh
