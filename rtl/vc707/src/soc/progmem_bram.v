...
`ifdef PROGMEM_RAMB
    ...
    // INIT params baked from firmware by bin2init.py into progmem_init.svh
    // (generated by run.tcl before synth; found via the src/soc include dir).
    // Literal filename — Vivado synth rejects `include of a macro.
    wire [31:0] doa;
    RAMB16_S36_S36 #(
