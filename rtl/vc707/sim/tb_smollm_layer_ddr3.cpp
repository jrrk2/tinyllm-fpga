...
#include "Vtb_smollm_layer_ddr3_dut.h"
#include "verilated.h"
#include <cstdio>
#include <cstdint>
#include <cstring>
...
static Vtb_smollm_layer_ddr3_dut* dut = nullptr;
...
int main(int argc, char** argv) {
    ...
    dut = new Vtb_smollm_layer_ddr3_dut;
    ...
    printf("PASS: smollm_layer (DDR3-streamer path) matches reference across all 11 trace points\n");
    delete dut;
    return 0;
}
